...
def load_settings():
    ...
    try:
        ...
        for line in settings:
            ...
            elif setting == "practiceTrial":
                if value != "": practiceTrial = int(value)
                print("Set number of practice to {}".format(value))
...
class trialScene(Scene):
    ...
    def on_update(self, delta, events):
        ...
        if (not self.is_paused):
            ...
            # if the subjects presses the SPACE key, end the trial
            # -----------------------------------------------------
...
class DetectScene(Scene):
    ...
    def save_trial(self):
        ...
        try:
            ...
            # Make a list and get the actual wolf name
