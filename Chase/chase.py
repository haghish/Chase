...
# os.chdir("/Users/haghish/dropbox/chase") #MAKE SURE THE WD IS CORRECT
#os.chdir("/Users/haghish/Dropbox/Company/Projects/2016/Chase/") 
...
class Player(Sprite):
    ...
    def update(self, *args):
        ...
        # -------------------------------
            ...
            angleNoise = scapeAngle[trialNumber]/2                            # 4) get a random noise angle
...
class Sheep(Sprite):
    ...
    def __init__(self, x, y, dx, dy):
        ...
        #print(sheepNumber, sheepNumberTracker)
    ...
    def update(self, *args):
        ...
        if (args[0] == -1):
            ...
            if (Second == None):
                Second = now
                #print("Second was none")

            #print("Second", Second)
            #print(now, Second, turnRate)
            ...
            #print(self.dx)
            #print("The Sheep Number is::", sheepNumber)
            #print(test)

            # UPDATE THE LOCATION OF THE SHEEP
            # ================================
            for x in range(0, sheepNumber):
                #print "test:", test, "x:", x
    ...
    def update(self, *args):
        ...
        if (Second  == now):
            ...
            if probability <= chaseRate[trialNumber]:
                ...
                angleNoise = chaseAngle[trialNumber]/2
        ...
        if (not self.is_paused):
            ...
            if ((len(self.sheep_group)+len(self.wolf_group))  < self.max_enemies):
                ...
                if (sheepNumberTracker != wolfNumberTracker):
                    self.spawn_sheep()
                    #print("SHEEP:", self.max_enemies)
                else:
                    self.spawn_wolf()
                    #print("WOLF:", self.max_enemies)
